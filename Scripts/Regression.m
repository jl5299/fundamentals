...
%
%    filename: C:\Users\Justin Law\Documents\Projects\Gillen - FA Optimization\fundamentals\Data\OrganizedData\1987Fundamentals.csv
%
% Auto-generated by MATLAB on 18-Jul-2020 10:28:34
...
opts.VariableNames = ["CUSIP", "Date", "PERMNO", "TICKER", "PRC", "SHROUT", "vwretd", "vwretx", "ewretd", "ewretx", "sprtrn", "GVKEY", "DATADATE", "qtrsback", "conm", "exchg", "sic", "tic", "datacqtr", "ACOQh", "AOQh", "APQh", "ATQh", "CEQQh", "CHEQh", "DLTTQh", "DOQh", "DVPQh", "DVQh", "IBADJQh", "IBCOMQh", "IBQh", "ICAPTQh", "LCOQh", "LOQh", "LTQh", "NIQh", "NOPIQh", "PIQh", "PPENTQh", "PSTKQh", "PSTKRQh", "SALEQh", "SEQQh", "TEQQh", "TXTQh", "XIDOQh", "capital"];
opts.VariableTypes = ["double", "double", "double", "string", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "string", "double", "double", "string", "categorical", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double"];
...
opts = setvaropts(opts, ["TICKER", "conm", "tic"], "WhitespaceRule", "preserve");
...
FundamentalFactors = Fundamentals{:,(20:47)};
...
logMarketCaps = log(Fundamentals{:,48});
