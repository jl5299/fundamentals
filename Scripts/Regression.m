...
%
%    filename: C:\Users\Justin Law\Documents\Projects\Gillen - FA Optimization\fundamentals\Data\OrganizedData\1987Data.csv
%
% Auto-generated by MATLAB on 10-Jul-2020 17:03:38
...
opts.VariableNames = ["CUSIP", "Date", "TICKER", "PERMNO", "n", "RET", "alpha", "b_mkt", "b_smb", "b_hml", "ivol", "tvol", "R2", "exret", "PRC", "SHROUT", "vwretd", "vwretx", "ewretd", "ewretx", "sprtrn", "GVKEY", "DATADATE", "qtrsback", "conm", "exchg", "sic", "tic", "datacqtr", "ACOQh", "AOQh", "APQh", "ATQh", "CEQQh", "CHEQh", "DLTTQh", "DOQh", "DVPQh", "DVQh", "IBADJQh", "IBCOMQh", "IBQh", "ICAPTQh", "LCOQh", "LOQh", "LTQh", "NIQh", "NOPIQh", "PIQh", "PPENTQh", "PSTKQh", "PSTKRQh", "SALEQh", "SEQQh", "TEQQh", "TXTQh", "XIDOQh", "capital"];
opts.VariableTypes = ["double", "double", "categorical", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "categorical", "double", "double", "categorical", "categorical", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double"];
...
opts = setvaropts(opts, ["TICKER", "conm", "tic", "datacqtr"], "EmptyFieldRule", "auto");
...
% Import the data
Data = readtable("C:\Users\Justin Law\Documents\Projects\Gillen - FA Optimization\fundamentals\Data\OrganizedData\1987Data.csv", opts);
...
for i = 1:N
    ...
    % trim data to exclude missing (nan) data
    temp = logical(1-isnan(Returns(:,i)));
    Ti = sum(temp);
    Ri = Returns(temp, i);
    ...
    PostThetai = PostV*(PriorV\PriorB + XprimeX*thetahat);
    ParamUncertaintyAdj = (thetahat - PriorB)'*...
